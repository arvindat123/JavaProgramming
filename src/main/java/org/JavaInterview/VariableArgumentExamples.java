...
public class VariableArgumentExamples {
	...
	public String sum(String p,int... numbers) {
	...
	public static void main(String[] args) {
		...
		// 3 Arguments
		System.out.println(example.sum("Arvind",1, 4, 5));// 10
		// 4 Arguments
		System.out.println(example.sum("Arvind",1, 4, 5, 20));// 30
		// 0 Arguments
		System.out.println(example.sum("Arvind"));// 0
	}
	 ...
	 * public int sum( float value, int... numbers) {//CORRECT }
	 */
