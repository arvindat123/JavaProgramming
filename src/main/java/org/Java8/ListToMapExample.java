...
public class ListToMapExample {
    public static void main(String[] args) {
        ...
        // List<MyObject> myList = List.of(new MyObject(2), new MyObject(4), new MyObject(6), new MyObject(8));
        ...
        // Stream AP solution
        Map<Integer, MyObject> myMapUsingStreamAPI = myList.stream().collect(Collectors.toMap(obj->obj.getUniqueId(), obj->obj));
